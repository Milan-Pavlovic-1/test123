  ...
  return (
    <Suspense fallback={<Loading cover="page"/>}>
      <Switch>
        ...
        <Route path={`${AUTH_PREFIX_PATH}/change-password`} component={lazy(() => import(`./authentication/change-password`))} />
        <Route path={`${AUTH_PREFIX_PATH}/change-forgot-password`} component={lazy(() => import(`./authentication/change-forgot-password`))} />
